...
1 – Install a package manager called Chocolatey, [link to Chocolatey](https://chocolatey.org/install)

2 – Install Ruby via Chocolatey, open a prompt as administrator and type it: 

    choco install ruby -y  

3 – Download the Ruby development kit windows, [link to download](http://rubyinstaller.org/downloads/) choose the right version for your system, 32 or 64 bits. Extract it in a folder, here's my suggestion: C:\tools\DevKit2
